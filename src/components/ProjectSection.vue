        ...
        <CarouselGlobal :class="isActive ? 'modaleMod' : 'carousel'" v-slot:projects="{ currentSlide }">
            <CarouselSlide class="carouselSlide" v-for="(slide, index) in carouselSlides" :key='index'>
                <div v-show="currentSlide === index + 1" class='slide-info'>
                    <img :src="require(`../assets/projects_pics/${slide.images}.png`)" alt="Illustration du projet">

                    <div @click="openGallery(index)" class="gallery">
                        <p>Plus d'images</p>  
    ...
    setup() {
        ...
        const carouselSlides = [
...

            {
                ...
                descriptionPart1: "L’élément principal de celui-ci était l’apprentissage de JavaScript (le back-end étant fourni pas OC), et l’utilisation des API.",
